...
public class TextHelper {
	...
	public static String TagClean(String value, String... tagNames) {
		...
		// 正则对象匹配模式
		// return
		// Pattern.compile(strReg,Pattern.CASE_INSENSITIVE).matcher(value).replaceAll("");
	...
	/**
	 * 将unix格式的字符串，转换为windows格式的，主要征对模板从数据库读出需要编辑的时候 还源字符串在编辑器中的格式
	 */
	...
	/**
	 * 返回符合条件的字符串 return 匹配的字符串，如果不匹配，则返回null
	 */
