...
public class ClientChannel  extends NioSocketChannel {
    ...
    private ProtocolResponsetEntity responseMessage;
    ...
    public ProtocolResponsetEntity get(long timeout) throws InterruptedException {
        lock.lock();
        try {
    ...
    public void set(ProtocolResponsetEntity message) {
        lock.lock();
        try {
